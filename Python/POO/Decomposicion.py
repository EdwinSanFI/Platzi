...
#Código de compañero de clase de PLATZI, lo dejó en el sistema de comentarios
print("\n\n")
...
class Automovil:
    ...
    def desAcelerar (self, tipo):  #Marca un subrayado, esto se arregla cambiandolo así 
        #des_acelerar
